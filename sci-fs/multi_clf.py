# -*- coding: utf-8 -*-
"""
Multiple classifier integrates the feature sorting algorithm based on scikit-learn for prediction.
Date: 2020-08-11
"""
import os
import sys
...
if __name__ == "__main__":
    ...
    acc_clf_fs = [accuracy_score(y, y_pred_dict[i]) for i in clf_dict.keys()]
    recall_pre_f1_clf_fs = [precision_recall_fscore_support(
        y, y_pred_dict[i], average='binary') for i in clf_dict.keys()]
