# -*- coding: utf-8 -*-
"""
This a Basic ConvNet implementation for training bio datasets and features output.
"""
import sys
import os
import time
...
if __name__ == "__main__":
    ...
    parser = ArgumentParser(description="This a Basic ConvNet implementation for training bio datasets and features output",
    ...
    parser.add_argument("-n", "--ratio", type=int,
                        help="The ratio of negative sample to positive sample. 1 or 2 times", default=1)
    ...
    from cnn.cnn_features import run_model
    run_model(args.datapath, args.learningrate, args.epochs, args.ratio, args.dropout, args.conv1h,
              args.conv1w, args.conv2h, args.conv2w, args.conv2f, args.datah, args.dataw, args.nclass)
