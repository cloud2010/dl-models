# -*- coding: utf-8 -*-
"""
The implementation is based on SNNs for predict bio datasets with kfold cross-validation.
Ref: `https://github.com/bioinf-jku/SNNs`
Author: Liu Min
...
if __name__ == "__main__":
    ...
    parser = ArgumentParser(description="This a SelfNormalizingNetworks implementation using Pytorch v0.4.0+ and scikit-learn v0.19+.",
