# -*- coding: utf-8 -*-
"""
A catboost classifier with SMOTE apply it to classify bio datasets.
Date: 2022-01-25
"""
# import os
import time
...
if __name__ == "__main__":
    ...
    # 初始化 classifier
    clf = CatBoostClassifier(random_state=args.randomseed,
                             iterations=args.epochs, max_depth=args.mdepth, verbose=False)
