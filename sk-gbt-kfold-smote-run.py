# -*- coding: utf-8 -*-
"""
This program implements Gradient Boosting Classifier for predicting biological sequence datasets.
Date: 2024-05-11
Author: Min
"""
import time
...
def parse_args():
    ...
    parser = ArgumentParser(
        description="This program implements Gradient Boosting Classifier for predicting biological sequence datasets.",
...
def train_and_evaluate(X, y, args):
    ...
    clf = GradientBoostingClassifier(
        n_estimators=100, learning_rate=1.0, random_state=args.randomseed
    )
