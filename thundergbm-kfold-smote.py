# -*- coding: utf-8 -*-
"""
A ThunderGBM classifier with SMOTE apply it to classify bio datasets.
Date: 2020-09-01
"""
# import os
import time
...
if __name__ == "__main__":
    ...
    parser = ArgumentParser(description="A ThunderGBM classifier with SMOTE apply it to classify bio datasets.",
