# -*- coding: utf-8 -*-
"""
A random forest classifier based on scikit-learn apply it to classify bio datasets.
Date: 2019-04-11
"""
# import os
import time
...
if __name__ == "__main__":
    ...
    parser = ArgumentParser(description="A random forest classifier based on scikit-learn apply it to classify bio datasets.",
