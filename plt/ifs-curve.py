...
max_index_lr1e_2_d5 = mcc_lr1e_2_d5.argmax(axis=0)
max_lr1e_3_d5 = mcc_lr1e_3_d5.max()
max_index_lr1e_3_d5 = mcc_lr1e_3_d5.argmax(axis=0)
max_lr1e_2_d3 = mcc_lr1e_2_d3.max()
max_index_lr1e_2_d3 = mcc_lr1e_2_d3.argmax(axis=0)
max_lr1e_3_d3 = mcc_lr1e_3_d3.max()
max_index_lr1e_3_d3 = mcc_lr1e_3_d3.argmax(axis=0)
...
# IFS 曲线
ax1.plot(x, mcc_lr1e_2_d5, linewidth="0.5", color="Blue", label="LR=1e-2, Depth=5")
ax1.plot(x, mcc_lr1e_3_d5, linewidth="0.5", color="C2", label="LR=1e-3, Depth=5")
# 最大点
ax1.plot(max_index_lr1e_2_d5, max_lr1e_2_d5, color="Blue", marker="*", markersize="14")
...
# IFS 曲线
ax2.plot(x, mcc_lr1e_2_d3, linewidth="0.5", color="C3", label="LR=1e-2, Depth=3")
ax2.plot(x, mcc_lr1e_3_d3, linewidth="0.5", color="C4", label="LR=1e-3, Depth=3")
# 最大点
ax2.plot(max_index_lr1e_2_d3, max_lr1e_2_d3, color="C3", marker="*", markersize="14")
ax2.plot(max_index_lr1e_3_d3, max_lr1e_3_d3, color="C4", marker="*", markersize="14")
# 文本标注
