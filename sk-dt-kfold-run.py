# -*- coding: utf-8 -*-
"""
A decision tree classifier based on scikit-learn apply it to classify bio datasets.
Date: 2019-06-19
"""
# import os
import time
...
if __name__ == "__main__":
    ...
    parser = ArgumentParser(description="A decision tree classifier based on scikit-learn apply it to classify bio datasets.",
