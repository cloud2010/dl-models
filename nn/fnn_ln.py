# -*- coding: utf-8 -*-
"""
Pytorch Implementation of FNN with ReLU Activation and Layer Normalization.
...
class FNNs(nn.Sequential):
    """Fully connected neural network with n hidden layers / Layer normalization / ReLU activation
    ...
    def __init__(self, input_size, hidden_size, dropout_rate, n_layers, num_classes):
        ...
        # 添加 LN 层
        self.add_module('fc_ln', nn.LayerNorm(hidden_size))
        # 激活函数
