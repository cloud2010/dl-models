# -*- coding: utf-8 -*-
"""
A deep forest classifier based on scikit-learn with SMOTE apply it to classify bio datasets.
Date: 2021-02-14
...
if __name__ == "__main__":
    ...
    parser = ArgumentParser(description="A deep forest classifier based on scikit-learn with SMOTE apply it to classify bio datasets.",
