# -*- coding: utf-8 -*-
"""
This program implements two linear classifiers for predicting biological sequence datasets.
Date: 2023-11-06
...
if __name__ == "__main__":
    ...
    parser = ArgumentParser(
        description="This program implements two ensemble classifiers for predicting biological sequence datasets.",
    ...
    parser.add_argument(
        ...
        "--classifier",
        type=str,
        help="Please specify which classifier to use. Lasso or Ridge",
        default="ridge",
    )
    parser.add_argument(
        "-n",
    ...
    if args.classifier == "lasso":
        clf = linear_model.Lasso(random_state=args.randomseed)
        print("\nThe Lasso Classifier")
    else:
        clf = RidgeClassifier(random_state=args.randomseed)
        print("\nRidgeClassifier")
