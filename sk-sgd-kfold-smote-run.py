# -*- coding: utf-8 -*-
"""
This program implements Stochastic Gradient Descent classifier for predicting biological sequence datasets.
Date: 2024-03-20
Author: Min
"""
# import os
...
if __name__ == "__main__":
    ...
    parser = ArgumentParser(
        description="This program implements Stochastic Gradient Descent classifier for predicting biological sequence datasets.",
    ...
    # 初始化 classifier
    clf = SGDClassifier(
        loss="hinge", penalty="l2", random_state=args.randomseed, n_jobs=-1
    )
